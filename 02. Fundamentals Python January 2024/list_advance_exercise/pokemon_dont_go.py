def manipulate_distance(distance_list, sum_removed_elements, current_index):
    ...
    for manipulated_index in range(len(distance_list)):
        if distance_list[manipulated_index] <= removed_element:
            distance_list[manipulated_index] += removed_element
        else:  # distance_list[manipulated_index] > removed_element:
            distance_list[manipulated_index] -= removed_element
